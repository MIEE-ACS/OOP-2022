...
* ЛР7: Разработка приложений с применением ООП ([docx](labs/абораторная работа 7.docx))
* ЛР8: Разработка мобильных приложений на языке C# при помощи платформы Xamarin.Forms ([docx](labs/Лабораторная работа 8.docx))
